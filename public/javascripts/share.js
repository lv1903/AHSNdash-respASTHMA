...
var sharePath = function() {
    ...
    switch (state_obj.reportType) {
        ...
        case "IndicatorReport":
            path = window.location.protocol + "//" + window.location.host + "/datavis/asthma/IndicatorReport/" + areaType + "/" + indicator + "/" + gender  + "/" + state_obj.current_area;
            break;

        case "OverviewReport":
            path = window.location.protocol + "//" + window.location.host + "/datavis/asthma/OverviewReport/" + areaType + "/" + state_obj.current_area + "/" + gender;
            break;

        case "AreaReport":
            path = window.location.protocol + "//" + window.location.host + "/datavis/asthma/AreaReport/" + areaType + "/" + state_obj.current_area + "/" + gender;
            break;
    }
...
var introUrl =  window.location.protocol + "//" + window.location.host + "/datavis/asthma"
