...
var buildPath = function(){
    ...
    if(reportType == "IndicatorReport"){
        ...
        path = window.location.protocol + "//" + window.location.host + "/datavis/asthma/IndicatorReport/" + outArr[0] + "/" + outArr[1] + "/" + outArr[2]  + "/" + outArr[3];
    ...
    if(reportType == "OverviewReport"){
        ...
        path = window.location.protocol + "//" + window.location.host + "/datavis/asthma/OverviewReport/" + outArr[0] + "/" + outArr[1] + "/" + outArr[2];
    }
    ...
    if(reportType == "AreaReport"){
        ...
        path = window.location.protocol + "//" + window.location.host + "/datavis/asthma/AreaReport/" + outArr[0] + "/" + outArr[1] + "/" + outArr[2];
    }
